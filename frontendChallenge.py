...
class SmartHomeSystem:
    def __init__(self, smartHome):
        ...
        self.smartPlugImg = PhotoImage(file = 'SmartPlug.png') # Load an image in my file
        self.smartPlugImg = self.smartPlugImg.subsample(10, 10) # The immage will be resized by the factor of 10 
        self.smartLightImg = PhotoImage(file = 'SmartLight.png')
        self.smartLightImg = self.smartLightImg.subsample(10, 10)
    def run(self):
        self.createWidget()
        self.win.mainloop()
    ######### Main Window #########
